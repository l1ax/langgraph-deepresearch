...
export abstract class BaseEvent<T extends BaseEvent.IContent>
  implements BaseEvent.IEvent<T>
{
  /** 事件唯一标识 */
  id: string;
   ...
   * @param runId 运行 ID（每次 invoke 不同，用于区分多轮对话）
   * @param nodeName 节点名称
   * @param eventType 事件类型
